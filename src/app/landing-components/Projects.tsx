        ...
        >
          <div className="flex flex-col h-fit w-240 items-center justify-start gap-5">
            ...
            <div className="flex flex-row justify-center items-center">
              <Image
                className={`rounded-sm z-4 w-60 h-35 lg:h-80 lg:w-140 drop-shadow-2xl/90 ${project.dropShadow}`}
                height={300}
                width={250}
              ...
              />
              <Image
                className="rounded-sm absolute left-1 lg:left-25 z-3 h-26 w-45 lg:h-60 lg:w-110 brightness-50 blur-[2px]"
                height={300}
                width={350}
              ...
              />
              <Image
                className="rounded-sm absolute right-1 lg:right-25 z-3 h-26 w-45 lg:h-60 lg:w-110 brightness-50 blur-[2px]"
                height={300}
                width={650}
            ...
            <div className="w-full h-fit px-5">
              <div>
                <div
                  className={`flex flex-row justify-between border-b-1 ${project.border} w-full`}
                >
                ...
                <div className="flex lg:flex-row flex-col lg:items-center gap-2 w-full">
                  ...
                  <div className="w-full h-fit flex flex-row gap-2">
                    ...
                    <div className="flex flex-col items-center ">
                      ...
                      <div className="h-[1px] w-[90%] bg-linear-to-r from-transparent via-white to-transparent"></div>
                    </div>
                  </div>
                </div>
              </div>
